...
let website = "/ForgePlay"

let githubLink = "https://github.com/Update GitHome in build.fsx/ForgePlay"

// Specify more information about your project
let info =
  [ "project-name", "ForgePlay"
    "project-author", "Update Author in build.fsx"
    "project-summary", "Project has no summmary; update build.fsx"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/ForgePlay" ]
